...
export const BOARD_CONFIG = [
    ...
    X('❓', 'chance'),
    B('Emigration for Action', '#87CEEB', 100000, 50000, 6000, 12000, 30000, 90000, 270000, 400000, 550000),
    B('Волонтёры Тбилиси', '#87CEEB', 120000, 50000, 8000, 16000, 40000, 100000, 300000, 450000, 600000),
    X('Арест', 'jail'),
    B('surikatamami', '#FF69B4', 140000, 100000, 10000, 20000, 50000, 150000, 450000, 625000, 750000),
    U('Silknet'),
    B('loly_tattoo', '#FF69B4', 140000, 100000, 10000, 20000, 50000, 150000, 450000, 625000, 750000),
    ...
    X('❓', 'chance'),
    B('Аудитория', '#FF0000', 220000, 150000, 18000, 36000, 90000, 250000, 700000, 875000, 1050000),
    ...
    U('Magticom'),
    B('kofevar', '#FFFF00', 280000, 150000, 24000, 48000, 120000, 360000, 850000, 1025000, 1200000),
    X('Досмотр', 'gotojail'),
    B('Improv Tbilisi', '#008000', 300000, 200000, 26000, 52000, 130000, 390000, 900000, 1100000, 1275000),
    B('Biblioteka', '#008000', 300000, 200000, 26000, 52000, 130000, 390000, 900000, 1100000, 1275000),
    X('❓', 'chest'),
    ...
    X('Налог', 'tax', 100000),
    B('Дружбодом', '#0000CD', 400000, 200000, 50000, 100000, 200000, 600000, 1400000, 1700000, 2000000),
];
