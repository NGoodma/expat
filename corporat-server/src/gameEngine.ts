...
export function evaluateCellLanding(room: GameRoom, pIndex: number, cellId: number): boolean {
    ...
    if (cell.type === 'property' || cell.type === 'station' || cell.type === 'utility') {
        ...
        const CHANCE_CARDS = [
            ...
            { amount: 80000, msg: "Открытие ИП в Доме Юстиции. Одобрили за 15 минут, сэкономили на юристе." },
            { amount: 120000, msg: "Tax Free сработал. Вернули налог за купленный в поездке Макбук." },
            { amount: 250000, msg: "Нашли сокровище у Сухого Моста. Продали старый ковер коллекционеру." },
            ...
            { amount: -80000, msg: "Купили Б/У Мак на MyMarket. Оказался с привязанным MDM-профилем чьей-то компании." },
            ...
            { amount: -70000, msg: "Эвакуировали машину в Сабуртало. Припарковались «на 5 минут» за шаурмой." },
